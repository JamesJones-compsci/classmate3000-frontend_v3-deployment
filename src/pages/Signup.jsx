...
// On success, firstName and lastName are passed to AuthContext so the sidebar
// can display the user's initials without a separate profile API call.
//
...
export default function Signup() {
  ...
  const canSubmit = useMemo(() => {
    return (
      ...
      password && confirmPassword &&
      !passwordMismatch && !passwordTooShort && !isSubmitting
    );
  ...
  const handleSubmit = async (e) => {
    ...
    if (passwordTooShort) return setError(`Password must be at least ${MIN_PASSWORD_LENGTH} characters.`);
    ...
    try {
      ...
      // Pass firstName and lastName so the sidebar can show user initials immediately.
      // Store token, name, and email — all used in sidebar profile panel.
      login(res.data.token, firstName.trim(), lastName.trim(), email.trim());
      navigate("/dashboard");
      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="auth-row">
            ...
            <input id="firstName" className="auth-input" type="text" value={firstName}
          ...
          <div className="auth-row">
            ...
            <input id="lastName" className="auth-input" type="text" value={lastName}
          ...
          <div className="auth-row">
            ...
            <div className="auth-input-wrap">
              ...
              <button type="button" className="auth-icon-btn"
